...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className=" flex flex-col items-center mt-0 py-0 md:py-24 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50 sm:min-h-[200vh] sm:mt-1 sm:pt-0"
    >
      <motion.h2
        style={{
        ...
        className="dark:text-white text-neutral-800 text-3xl font-bold mb-20 text-center sm:mt-0 sm:pt-0 "
      >
        {title || (
          <span>
      ...
      <div className="h-[22rem] w-[32rem] bg-gray-200 dark:bg-[#272729] rounded-2xl overflow-hidden relative -z-10">
        ...
        {showGradient && (
          <div className="h-10 w-full absolute bottom-0 inset-x-0 bg-gradient-to-t dark:from-black from-white via-white dark:via-black to-transparent z-50"></div>
        )}
